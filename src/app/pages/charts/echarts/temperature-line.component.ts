...
@Component({
  selector: 'ngx-temperature-line',
  template: `
    <div echarts [options]="options" class="echart"></div>
  `,
})
export class TemperatureLineComponent implements OnInit, AfterViewInit, OnDestroy {
  options: any = {};
  ...
  updateChartOptions() {
    ...
    if (this.data) {
      ...
      if (this.data['Da Nang'] && this.data['Da Nang'].hourly && this.data['Da Nang'].hourly.temperature_2m) {
        daNangData = this.data['Da Nang'].hourly.temperature_2m;
      }

      if (this.data['Ho Chi Minh City'] && this.data['Ho Chi Minh City'].hourly &&
        this.data['Ho Chi Minh City'].hourly.temperature_2m) {
        hoChiMinhData = this.data['Ho Chi Minh City'].hourly.temperature_2m;
      }

      if (this.data['Ha Noi'] && this.data['Ha Noi'].hourly &&
        this.data['Ha Noi'].hourly.temperature_2m) {
        haNoiData = this.data['Ha Noi'].hourly.temperature_2m;
      }
    }
